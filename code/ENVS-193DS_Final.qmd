...
predicted_at_600 <- predict(model_intereactive, 
                            newdata = max_height_data, 
                            type = "response")

# Bind predictions to the labels for clear reading
cbind(max_height_data, 
      predicted_probability = predicted_at_600)
```
